...
final class MapperTests: XCTestCase {
    ...
    func testUserMapper() {
        ...
        let result = UserMapper().convert(
            response: .init(
                status: 200,
                result: .init(id: 1, email: "test@test.com", token: "token")
            )
        )
    ...
    func testBookListMapper() {
        let expect: [BookEntity] = [
            .init(id: 1, name: "test", image: "test.png", price: 100, purchaseDate: "2000-01-01")
        ]
