...
struct R: Rswift.Validatable {
  ...
  struct storyboard {
    ...
    static func addBookViewController(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.addBookViewController)
    }
    #endif
    ...
    static func bookListViewController(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.bookListViewController)
    }
    #endif
    ...
    static func chatRoomViewController(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.chatRoomViewController)
    }
    #endif
    ...
    static func chatSelectViewController(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.chatSelectViewController)
    }
    #endif
    ...
    static func chatUserListViewController(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.chatUserListViewController)
    }
    #endif
    ...
    static func editBookViewController(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.editBookViewController)
    }
    #endif
    ...
    static func wishListViewController(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.wishListViewController)
    }
    #endif
  ...
  struct image {
    ...
    /// Image `Check_In_Box`.
    static let check_In_Box = Rswift.ImageResource(bundle: R.hostingBundle, name: "Check_In_Box")
    /// Image `Check_Off_Box`.
    static let check_Off_Box = Rswift.ImageResource(bundle: R.hostingBundle, name: "Check_Off_Box")
    /// Image `Favorite`.
    ...
    static let no_Selected_AddBook = Rswift.ImageResource(bundle: R.hostingBundle, name: "No_Selected_AddBook")
    /// Image `No_Selected_BookList`.
    static let no_Selected_BookList = Rswift.ImageResource(bundle: R.hostingBundle, name: "No_Selected_BookList")
    /// Image `No_Selected_Chat`.
    static let no_Selected_Chat = Rswift.ImageResource(bundle: R.hostingBundle, name: "No_Selected_Chat")
    /// Image `No_Selected_Wishlist`.
    static let no_Selected_Wishlist = Rswift.ImageResource(bundle: R.hostingBundle, name: "No_Selected_Wishlist")
    /// Image `No_favorite`.
    static let no_favorite = Rswift.ImageResource(bundle: R.hostingBundle, name: "No_favorite")
    /// Image `Selected_AddBook`.
    static let selected_AddBook = Rswift.ImageResource(bundle: R.hostingBundle, name: "Selected_AddBook")
    /// Image `Selected_BookList`.
    static let selected_BookList = Rswift.ImageResource(bundle: R.hostingBundle, name: "Selected_BookList")
    /// Image `Selected_Chat`.
    static let selected_Chat = Rswift.ImageResource(bundle: R.hostingBundle, name: "Selected_Chat")
    /// Image `Selected_WishList`.
    static let selected_WishList = Rswift.ImageResource(bundle: R.hostingBundle, name: "Selected_WishList")
    /// Image `Send`.
    ...
    /// Image `add_chat_user`.
    static let add_chat_user = Rswift.ImageResource(bundle: R.hostingBundle, name: "add_chat_user")

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "Add_book", bundle: ..., traitCollection: ...)`
    static func add_book(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.add_book, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "Book_list", bundle: ..., traitCollection: ...)`
    static func book_list(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.book_list, compatibleWith: traitCollection)
    }
    #endif
    ...
    static func check_In_Box(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.check_In_Box, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "Check_Off_Box", bundle: ..., traitCollection: ...)`
    static func check_Off_Box(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.check_Off_Box, compatibleWith: traitCollection)
    }
    #endif
    ...
    static func no_Selected_AddBook(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.no_Selected_AddBook, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "No_Selected_BookList", bundle: ..., traitCollection: ...)`
    static func no_Selected_BookList(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.no_Selected_BookList, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "No_Selected_Chat", bundle: ..., traitCollection: ...)`
    static func no_Selected_Chat(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.no_Selected_Chat, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "No_Selected_Wishlist", bundle: ..., traitCollection: ...)`
    static func no_Selected_Wishlist(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.no_Selected_Wishlist, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "No_favorite", bundle: ..., traitCollection: ...)`
    static func no_favorite(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.no_favorite, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "Selected_AddBook", bundle: ..., traitCollection: ...)`
    static func selected_AddBook(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.selected_AddBook, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "Selected_BookList", bundle: ..., traitCollection: ...)`
    static func selected_BookList(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.selected_BookList, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "Selected_Chat", bundle: ..., traitCollection: ...)`
    static func selected_Chat(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.selected_Chat, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "Selected_WishList", bundle: ..., traitCollection: ...)`
    static func selected_WishList(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.selected_WishList, compatibleWith: traitCollection)
    }
    #endif
    ...
    static func wish_list(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.wish_list, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "add_chat_user", bundle: ..., traitCollection: ...)`
    static func add_chat_user(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.add_chat_user, compatibleWith: traitCollection)
    }
    #endif
  ...
  struct nib {
    ...
    @available(*, deprecated, message: "Use UINib(resource: R.nib.bookListTableViewCell) instead")
    static func bookListTableViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.bookListTableViewCell)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "ChatSelectTableViewCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.chatSelectTableViewCell) instead")
    static func chatSelectTableViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.chatSelectTableViewCell)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "ChatUserListTableViewCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.chatUserListTableViewCell) instead")
    static func chatUserListTableViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.chatUserListTableViewCell)
    }
    #endif
    ...
    @available(*, deprecated, message: "Use UINib(resource: R.nib.keyboardAccessoryView) instead")
    static func keyboardAccessoryView(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.keyboardAccessoryView)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "MyMessageTableViewCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.myMessageTableViewCell) instead")
    static func myMessageTableViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.myMessageTableViewCell)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "OtherMessageTableViewCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.otherMessageTableViewCell) instead")
    static func otherMessageTableViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.otherMessageTableViewCell)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "WishListTableViewCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.wishListTableViewCell) instead")
    static func wishListTableViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.wishListTableViewCell)
    }
    #endif

    static func bookListTableViewCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> BookListTableViewCell? {
      return R.nib.bookListTableViewCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? BookListTableViewCell
    }

    static func chatSelectTableViewCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> ChatSelectTableViewCell? {
      return R.nib.chatSelectTableViewCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? ChatSelectTableViewCell
    }

    static func chatUserListTableViewCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> ChatUserListTableViewCell? {
      return R.nib.chatUserListTableViewCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? ChatUserListTableViewCell
    }
    ...
    static func keyboardAccessoryView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.keyboardAccessoryView.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }

    static func myMessageTableViewCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> MyMessageTableViewCell? {
      return R.nib.myMessageTableViewCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? MyMessageTableViewCell
    }

    static func otherMessageTableViewCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> OtherMessageTableViewCell? {
      return R.nib.otherMessageTableViewCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? OtherMessageTableViewCell
    }

    static func wishListTableViewCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> WishListTableViewCell? {
      return R.nib.wishListTableViewCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? WishListTableViewCell
    }
  ...
  struct string {
    ...
    struct localizable {
      /// Value: %@が入力されていません
      static let not_filled = Rswift.StringResource(key: "not_filled", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: +
      static let plus = Rswift.StringResource(key: "plus", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: いいえ
      static let no = Rswift.StringResource(key: "no", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: お気に入り書籍
      static let wish_list_book = Rswift.StringResource(key: "wish_list_book", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: ご入力内容をもう一度ご確認ください
      static let please_check_again_contents = Rswift.StringResource(key: "please_check_again_contents", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: はい
      ...
      static let not_longer_title_text = Rswift.StringResource(key: "not_longer_title_text", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: チャット
      static let chat = Rswift.StringResource(key: "chat", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: トーク一覧
      static let talk_list = Rswift.StringResource(key: "talk_list", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: トーク開始
      static let start_talk = Rswift.StringResource(key: "start_talk", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: ニックネーム
      static let nick_name = Rswift.StringResource(key: "nick_name", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: パスワード
      ...
      static let not_matching_password = Rswift.StringResource(key: "not_matching_password", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: パスワードは%@文字以上で入力が必要です
      static let not_length_password = Rswift.StringResource(key: "not_length_password", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: ホーム
      static let home = Rswift.StringResource(key: "home", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: メールアドレス
      static let mail_address = Rswift.StringResource(key: "mail_address", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: メールアドレスが使用されている可能性があります
      static let maybe_already_email = Rswift.StringResource(key: "maybe_already_email", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: メールアドレスが正しいフォームで入力されていません
      static let not_correct_format_email = Rswift.StringResource(key: "not_correct_format_email", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: ユーザー選択
      static let select_user = Rswift.StringResource(key: "select_user", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: ログアウト
      static let logout = Rswift.StringResource(key: "logout", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: ログアウトしますか？
      static let did_you_logout = Rswift.StringResource(key: "did_you_logout", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: ログアウトに失敗しました
      static let failed_logout = Rswift.StringResource(key: "failed_logout", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: ログインに失敗しました
      static let failed_login = Rswift.StringResource(key: "failed_login", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 円
      static let yen = Rswift.StringResource(key: "yen", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 失敗
      static let failure = Rswift.StringResource(key: "failure", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 完了
      ...
      /// Value: 数字のみご入力ください
      static let only_input_number = Rswift.StringResource(key: "only_input_number", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 書籍の取得に失敗しました
      static let failed_book_list = Rswift.StringResource(key: "failed_book_list", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 書籍一覧
      static let book_list = Rswift.StringResource(key: "book_list", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 書籍登録が完了しました
      static let success_add_book = Rswift.StringResource(key: "success_add_book", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 書籍登録に失敗しました
      static let failed_add_book = Rswift.StringResource(key: "failed_add_book", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 書籍編集
      static let edit_book = Rswift.StringResource(key: "edit_book", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 書籍編集が完了しました
      static let success_edit_book = Rswift.StringResource(key: "success_edit_book", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 書籍編集に失敗しました
      static let failed_edit_book = Rswift.StringResource(key: "failed_edit_book", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 書籍追加
      static let add_book = Rswift.StringResource(key: "add_book", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 登録に失敗しました
      static let failed_signup = Rswift.StringResource(key: "failed_signup", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 税
      static let tax = Rswift.StringResource(key: "tax", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 購入日
      static let purchase_date = Rswift.StringResource(key: "purchase_date", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: 追加
      ...
      /// Value: %@が入力されていません
      static func not_filled(_ value1: String, preferredLanguages: [String]? = nil) -> String {
      ...
      static func please_check_again_contents(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("please_check_again_contents", bundle: hostingBundle, comment: "")
        }
      ...
      /// Value: タイトル名は%@文字以下でご入力ください
      static func not_longer_title_text(_ value1: String, preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          let format = NSLocalizedString("not_longer_title_text", bundle: hostingBundle, comment: "")
          return String(format: format, locale: applicationLocale, value1)
        }
      ...
      static func not_matching_password(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("not_matching_password", bundle: hostingBundle, comment: "")
        }
      ...
      /// Value: パスワードは%@文字以上で入力が必要です
      static func not_length_password(_ value1: String, preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          let format = NSLocalizedString("not_length_password", bundle: hostingBundle, comment: "")
          return String(format: format, locale: applicationLocale, value1)
        }
      ...
      static func maybe_already_email(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("maybe_already_email", bundle: hostingBundle, comment: "")
        }
      ...
      static func not_correct_format_email(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("not_correct_format_email", bundle: hostingBundle, comment: "")
        }
      ...
      static func only_input_number(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("only_input_number", bundle: hostingBundle, comment: "")
        }
      ...
      static func success_edit_book(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("success_edit_book", bundle: hostingBundle, comment: "")
        }
...
struct _R: Rswift.Validatable {
  ...
  struct nib: Rswift.Validatable {
    ...
    struct _BookListTableViewCell: Rswift.NibResourceType, Rswift.Validatable {
      ...
      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> BookListTableViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? BookListTableViewCell
      }

      static func validate() throws {
        if UIKit.UIImage(named: "No_favorite", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'No_favorite' is used in nib 'BookListTableViewCell', but couldn't be loaded.") }
    ...
    struct _ChatSelectTableViewCell: Rswift.NibResourceType {
      ...
      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> ChatSelectTableViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? ChatSelectTableViewCell
      }
    ...
    struct _ChatUserListTableViewCell: Rswift.NibResourceType {
      ...
      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> ChatUserListTableViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? ChatUserListTableViewCell
      }
    ...
    struct _KeyboardAccessoryView: Rswift.NibResourceType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "Send", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'Send' is used in nib 'KeyboardAccessoryView', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
    ...
    struct _MyMessageTableViewCell: Rswift.NibResourceType {
      ...
      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> MyMessageTableViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? MyMessageTableViewCell
      }
    ...
    struct _OtherMessageTableViewCell: Rswift.NibResourceType {
      ...
      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> OtherMessageTableViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? OtherMessageTableViewCell
      }
    ...
    struct _WishListTableViewCell: Rswift.NibResourceType {
      ...
      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> WishListTableViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? WishListTableViewCell
      }
  ...
  struct storyboard: Rswift.Validatable {
    ...
    #if os(iOS) || os(tvOS)
    struct addBookViewController: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "No_Image", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'No_Image' is used in storyboard 'AddBookViewController', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
    ...
    #if os(iOS) || os(tvOS)
    struct bookListViewController: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
    ...
    #if os(iOS) || os(tvOS)
    struct chatRoomViewController: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
    ...
    #if os(iOS) || os(tvOS)
    struct chatSelectViewController: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
    ...
    #if os(iOS) || os(tvOS)
    struct chatUserListViewController: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
    ...
    #if os(iOS) || os(tvOS)
    struct editBookViewController: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "No_Image", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'No_Image' is used in storyboard 'EditBookViewController', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
    ...
    struct loginViewController: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "Check_Off_Box", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'Check_Off_Box' is used in storyboard 'LoginViewController', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
    ...
    #if os(iOS) || os(tvOS)
    struct signupViewController: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "Check_Off_Box", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'Check_Off_Box' is used in storyboard 'SignupViewController', but couldn't be loaded.") }
        if UIKit.UIImage(named: "No_Image", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'No_Image' is used in storyboard 'SignupViewController', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
    ...
    #if os(iOS) || os(tvOS)
    struct wishListViewController: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
